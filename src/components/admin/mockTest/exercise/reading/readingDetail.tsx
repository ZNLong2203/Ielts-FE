...
const ReadingDetail = () => {
  ...
  const estimatedReadingTime = (wordCount: number) => {
                    ...
                    <div className="text-center">
                      <div className="text-2xl font-bold text-purple-600">
                        {readingExercise.reading_passage
                          ...
                          estimatedReadingTime(wordCount)}
                      </div>
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-2 text-sm text-gray-600">
                  ...
                  <p>
                    • Reading time: ~{estimatedReadingTime(wordCount)} minutes
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            {readingExercise.instruction && (
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-700">{readingExercise.instruction}</p>
                </CardContent>
              </Card>
            )}
