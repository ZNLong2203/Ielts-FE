...
export const CourseComboCreateSchema = z.object({
    ...
    discount_percentage: z.number().min(1, "Discount price must be positive").min(1, "Discount price must be less than or equal to price"),
...
export const CourseComboUpdateSchema = z.object({
    ...
    discount_percentage: z.number().min(1, "Discount price must be positive").min(1, "Discount price must be less than or equal to price").optional(),
